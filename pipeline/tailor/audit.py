...
def check_fabrication(original: dict, tailored: dict, orig_text: str, jd_text: str,
    ...
    if merge_low_value:
        # UP3: low-value roles may be cut or merged — but every company still
        # present must exist in the original (no invented employers), whether
        # or not the counts happen to match.
        for b in ne:
